...
## Documentation For Models
 ...
 - [OneOfDocumentInsertInstantPaymentRequest](docs/Model/OneOfDocumentInsertInstantPaymentRequest.md)
 - [OneOfDocumentInsertItemsItems](docs/Model/OneOfDocumentInsertItemsItems.md)
 - [OneOfDocumentPartnerPartnerShipping](docs/Model/OneOfDocumentPartnerPartnerShipping.md)
 - [OneOfDocumentSettingsDontSendToNavReason](docs/Model/OneOfDocumentSettingsDontSendToNavReason.md)
 - [OneOfDocumentSettingsInstantPaymentRequest](docs/Model/OneOfDocumentSettingsInstantPaymentRequest.md)
 - [OneOfModificationDocumentInsertItemsItems](docs/Model/OneOfModificationDocumentInsertItemsItems.md)
 - [OneOfPartnerGiroSettings](docs/Model/OneOfPartnerGiroSettings.md)
 - [OneOfPartnerPartnerShipping](docs/Model/OneOfPartnerPartnerShipping.md)
 - [OneOfPartnerPartnerShowType](docs/Model/OneOfPartnerPartnerShowType.md)
 - [OneOfPartnerShippingAddress](docs/Model/OneOfPartnerShippingAddress.md)
