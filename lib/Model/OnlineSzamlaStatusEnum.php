...
class OnlineSzamlaStatusEnum
{
    ...
    const DONE = 'done';
    const DONT_SEND_EXTERNAL_IMPORT = 'dont_send_external_import';
    const DONT_SEND_FOREIGN = 'dont_send_foreign';
    const DONT_SEND_OSS = 'dont_send_oss';
    const DONT_SEND_OTHER = 'dont_send_other';
