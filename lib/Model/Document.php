...
class Document implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['recurring_id'] = isset($data['recurring_id']) ? $data['recurring_id'] : null;
    }
     ...
     * Sets paid_date
     *
     * @param \DateTime $paid_date If payment_status equals 'paid' or 'partially_paid', it will show the paid date otherwise the current date.
     *
     * @return $this
     */
     ...
     * Sets recurring_id
     *
     * @param int $recurring_id recurring_id
     *
     * @return $this
     */
